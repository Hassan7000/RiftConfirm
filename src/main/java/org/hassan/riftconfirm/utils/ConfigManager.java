...
public class ConfigManager {
	...
	private RiftConfirm plugin = null;

	public void setPlugin(RiftConfirm plugin) {
		this.plugin = plugin;
	}
	...
	public boolean addLog(FileConfiguration conf, String path, String pack, String accept, String trans, String date, String time, Player player){
		conf.set(String.format("%s.Player", path), player.getName());
		conf.set(String.format("%s.Package", path), pack);
		conf.set(String.format("%s.Accepted", path), accept);
		conf.set(String.format("%s.Transaction", path), trans);
		conf.set(String.format("%s.Date", path), date.replace(":", "-"));
		conf.set(String.format("%s.Time", path), time.replace(":", "-"));
		return saveData(conf);
	}
